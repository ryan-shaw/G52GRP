...
//  Fruit Machine Game
//
//  Created by Stephen Sowole on 07/11/2013.
//  Copyright G52GRP 2013. All rights reserved.
//
...
-(void) directorDidReshapeProjection:(CCDirector*)director
{
	if(director.runningScene == nil) {
		...
		[director runWithScene: [PopTheCloud scene]];
	}
}
@end
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
	...
	[sharedFileUtils setiPadRetinaDisplaySuffix:@"@4x"];	// Default on iPad RetinaDisplay is "-ipadhd"
